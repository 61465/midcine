...
const ERA_DB = {
  era1: {
    ...
    imageUrl: proxyUrl('https://upload.wikimedia.org/wikipedia/commons/5/50/Computed_tomography_of_human_brain_-_large.png'),
    fallbackUrl: null,
    noisePattern: 'heavy',
...
حصل هاونسفيلد وكورماك على جائزة نوبل للطب 1979 تقديراً لهذا الاختراع.`,
    compare: 'قياساً بالتصوير الحديث: الجرعة أعلى 13 مرة، الدقة أقل بـ 40 مرة، وزمن الفحص أبطأ بـ 2000 مرة.',
    specs: [
    ...
    report: {
      technique: 'Non-contrast axial CT acquisition using EMI Mark I pencil-beam scanner. Matrix 80×80. Single detector element. Scan time 300 seconds per image. No reformats available.',
      findings: 'Limited diagnostic quality due to first-generation scanner constraints. High image noise significantly limits grey-white matter differentiation. Identifiable midline structures visible. Bony calvaria delineated. No gross mass lesion identified on this limited examination.',
      impression: '1. First-generation CT scan of limited diagnostic quality. 2. No definitive acute intracranial abnormality identified, though sensitivity is low. 3. Follow-up with modern CT recommended for complete evaluation.',
    },
  },
...
الجرعة انخفضت لـ 10 mSv بفضل الكواشف الأكثر كفاءة وكولماتور أفضل.`,
    compare: 'أسرع 60 مرة من الجيل الأول، دقة أعلى 10 مرات، لكن الجرعة لا تزال أعلى من الحديثة بـ 7 مرات.',
    specs: [
    ...
    report: {
      technique: 'Non-contrast axial CT brain using third-generation fan-beam scanner. Matrix 256×256. 10mm contiguous axial images. FBP reconstruction with Shepp-Logan filter.',
      findings: 'Improved image quality compared to first-generation CT. Grey-white matter differentiation present but limited by residual noise. Ventricular system normal in size and configuration. No focal parenchymal lesion. Basal ganglia structures visible. No evidence of acute hemorrhage.',
      impression: '1. No acute intracranial pathology identified. 2. Image quality limited by 1980s scanner technology. 3. Modern CT would provide significantly improved anatomical detail.',
    },
  },
...
أتاح التصوير المجسم (MPR) مشاهدة المقاطع السهمية والتاجية بجودة عالية.`,
    ...
    report: {
      technique: 'Non-contrast axial CT brain using 4-slice helical scanner. Matrix 512×512, 5mm slice thickness, 120kVp/200mAs. Iterative reconstruction applied. Coronal and sagittal reformats available.',
      findings: 'Good quality examination. Brain parenchyma demonstrates normal grey-white matter differentiation. Ventricular system normal in caliber. Cerebral sulci are appropriate for age. Basal cisterns patent. No abnormal density lesion. Cerebellopontine angles clear. Midline structures in normal position.',
      impression: '1. Normal brain CT for age and clinical presentation. 2. Adequate diagnostic quality with helical multi-slice technique. 3. No acute intracranial abnormality.',
    },
  },
...
دقة إيزوتروبية 0.24 مم × 0.24 مم × 0.24 مم في ثلاثة أبعاد.`,
    ...
    report: {
      technique: 'CT brain without intravenous contrast using Siemens SOMATOM X.cite 640-slice scanner. 120kVp, CARE Dose 4D, 0.6mm collimation, Deep Learning Reconstruction (DLR). Axial, coronal, and sagittal reformats reviewed. Effective dose: 1.5 mSv.',
      findings: 'Excellent image quality with AI-assisted reconstruction. Normal grey-white matter differentiation. Ventricular system symmetric, normal in caliber. Cortical sulci appropriate for age. No intra-axial or extra-axial collections. No midline shift. Basal ganglia, thalami, and brainstem unremarkable. Posterior fossa structures normal. Bony calvaria intact. No acute hemorrhage. No definite acute ischemic change. Orbits and paranasal sinuses grossly clear.',
      impression: '1. Normal CT brain without contrast — AI-enhanced DLR acquisition. 2. No acute intracranial pathology. 3. Excellent diagnostic quality — 0.6mm isotropic resolution.',
    },
  },
...
• المحور Z الأفقي: مسح تشريحي كامل من قاعدة الجمجمة (-60 mm) حتى القمة (+60 mm).`,
    ...
    report: {
      technique: 'Comprehensive Brain Multi-Parametric 4D protocol (Machine: SIGNA_AURORA_3T / PCD Hybrid). Co-registered acquisition of 35 multi-spectral slices spanning T2 FLAIR, DWI (b:1000), ADC map, quantitative CBF Perfusion (0-150 ml/100g/min), and High-Resolution SWI.',
      findings: '1. T2 FLAIR: Normal cerebral parenchyma without periventricular hyperintensities or demyelinating lesions. 2. DWI (b:1000) & ADC: No acute restricted diffusion or cytotoxic edema (no acute territorial infarct). 3. CBF Perfusion: Symmetrical, robust cerebral blood flow (55-75 ml/100g/min) across all vascular territories without penumbra or hypo-perfusion. 4. SWI: Intact microvascular architecture; zero microbleeds or intravascular thrombi.',
      impression: '1. Normal 4D multi-parametric neurovascular study. 2. No evidence of acute ischemia, restricted diffusion, or microvascular hemorrhage. 3. Symmetrical, optimal cerebral hemodynamics across all 35 volume slices.',
    },
  },
};
...
const SCAN_IMAGE_MAP = {
  multiparametric_4d:
    'multiparametric_4d_brain.jpg',
  brain:
    proxyUrl('https://upload.wikimedia.org/wikipedia/commons/5/50/Computed_tomography_of_human_brain_-_large.png'),
  chest:
    proxyUrl('https://upload.wikimedia.org/wikipedia/commons/5/57/HR_tomography_of_the_chest_of_an_IPF_patient_1.jpg'),
  spine:
    proxyUrl('https://upload.wikimedia.org/wikipedia/commons/8/8c/3D_CT_reconstruction_of_human_lumbar_spine_and_sacrum_%28anterior_view%29_-_Navi_Mumbai.jpg'),
  abdomen:
    proxyUrl('https://upload.wikimedia.org/wikipedia/commons/0/08/CT_Abdomen_Scan.jpg'),
  cardiac:
    proxyUrl('https://upload.wikimedia.org/wikipedia/commons/d/d0/Ct-angiography.png'),
  historical_1971:
    proxyUrl('https://upload.wikimedia.org/wikipedia/commons/5/50/Computed_tomography_of_human_brain_-_large.png'),
  polytrauma:
    proxyUrl('https://upload.wikimedia.org/wikipedia/commons/8/8c/3D_CT_reconstruction_of_human_lumbar_spine_and_sacrum_%28anterior_view%29_-_Navi_Mumbai.jpg'),
  pet:
    proxyUrl('https://upload.wikimedia.org/wikipedia/commons/9/9d/PET_scan-normal_brain-alzheimers_disease_brain.PNG'),
  sinus:
    proxyUrl('https://upload.wikimedia.org/wikipedia/commons/5/57/HR_tomography_of_the_chest_of_an_IPF_patient_1.jpg'),
  angiography:
    proxyUrl('https://upload.wikimedia.org/wikipedia/commons/d/d0/Ct-angiography.png'),
  chest_standard:
    proxyUrl('https://upload.wikimedia.org/wikipedia/commons/9/9a/COR-2-STND-CHEST-LUNGS.jpg'),
};
...
const SCAN_METADATA = {
  multiparametric_4d: {
    ...
    defaultWW: 256,
    colormap: 'gray',
    technique: 'Multi-Parametric 4D study (Machine: SIGNA_AURORA_3T / PCD Hybrid) with 35 co-registered slices across T2 FLAIR, DWI (b:1000), ADC, dynamic CBF Perfusion, and high-resolution SWI.',
    findings: 'Multi-parametric analysis reveals completely symmetric parenchymal signal, free Brownian water diffusion without cytotoxic restriction, normal hemodynamic perfusion (CBF 55-75 ml/100g/min), and patent microvascular structures without micro-hemorrhages.',
    impression: '1. Normal 4D multi-parametric examination. 2. No acute ischemia, restricted diffusion, or microvascular pathology across all 35 matrix slices.'
  },
  brain: {
    ...
    defaultWW: 80,
    colormap: 'gray',
    technique: 'Axial contiguous volumetric non-contrast CT acquisition of the head from skull base to vertex with iterative AI denoising.',
    findings: 'Normal cerebral cortex and deep white matter attenuation. Ventricles and basal cisterns are unremarkable and symmetric. No intra- or extra-axial hemorrhage, mass effect, or midline shift. Calvarium is intact.',
    impression: '1. Normal non-contrast CT brain. 2. No acute intracranial hemorrhage, major territorial infarction, or mass effect.'
  },
  chest: {
    ...
    defaultWW: 1500,
    colormap: 'gray',
    technique: 'Thin-section volumetric high-resolution CT of the thorax acquired at full inspiration. Reconstructed using sharp lung parenchyma kernel.',
    findings: 'Lung parenchyma demonstrates patent airways down to subsegmental bronchi. Pulmonary vasculature tapers normally without focal oligaemia or congestion. Mediastinal contours, hila, and pleural spaces are clear without effusion or pneumothorax.',
    impression: '1. Clear lung parenchyma without focal consolidation or interstitial reticulation. 2. Normal thoracic CT examination.'
  },
  chest_standard: {
    ...
    findings: 'Normal cardiac silhouette and pericardium. Major mediastinal vessels (ascending aorta, aortic arch, pulmonary trunk) show normal caliber. No pathological mediastinal or hilar lymphadenopathy.',
    impression: '1. Unremarkable contrast-enhanced thoracic CT. 2. No mediastinal mass or adenopathy.'
  },
  spine: {
    ...
    defaultWW: 1800,
    colormap: 'bone',
    technique: 'Volumetric CT acquisition of the lumbar spine and sacrum with high-resolution bone kernel and 3D surface-rendered multiplanar reformations.',
    findings: 'Preserved lumbar lordosis. Vertebral body heights and alignment are intact. Intervertebral disc spaces demonstrate normal height without vacuum phenomenon. Facet joints and sacroiliac joints appear smooth and symmetrical. Neural foramina and central spinal canal are patent.',
    impression: '1. Structurally intact lumbar spine and sacrum on 3D reconstruction. 2. No acute fracture, subluxation, or high-grade degenerative canal stenosis.'
  },
  abdomen: {
    ...
    defaultWW: 400,
    colormap: 'gray',
    technique: 'Intravenous contrast-enhanced CT of the abdomen and pelvis scanned in the portal venous phase (70s delay).',
    findings: 'Liver demonstrates homogenous attenuation without focal lesion. Gallbladder, biliary tree, spleen, pancreas, and adrenal glands are normal. Both kidneys excrete contrast symmetrically. Gastrointestinal tract shows normal wall thickness without obstruction or mesenteric lymphadenopathy.',
    impression: '1. Normal contrast-enhanced CT examination of the abdomen and pelvis. 2. No solid organ abnormality or acute intra-abdominal process.'
  },
  cardiac: {
    ...
    defaultWW: 600,
    colormap: 'spectral',
    technique: 'ECG-gated volumetric coronary CT angiography using dual-source 640-slice platform with prospective triggering at 75% R-R interval.',
    findings: 'Left main coronary artery (LMCA), Left Anterior Descending (LAD), Left Circumflex (LCx), and Right Coronary Artery (RCA) demonstrate wide lumen patency. Zero Agatston coronary artery calcium score (CACS = 0). No non-calcified or mixed soft plaques.',
    impression: '1. Coronary Artery Disease - Reporting and Data System: CAD-RADS 0 (No coronary atherosclerosis). 2. Excellent prognostic profile.'
  },
  angiography: {
    ...
    defaultWW: 700,
    colormap: 'hot',
    technique: 'Bolus-tracked arterial phase CT angiogram with high-flow iodinated contrast injection (5 mL/s).',
    findings: 'Uniform contrast opacification of the thoracic aorta and principal branching vessels without dissection flap, aneurysm, or intraluminal thrombus. Coronary ostia originate normally.',
    impression: '1. Normal vascular CTA reconstruction without evidence of aneurysm, dissection, or critical stenosis.'
  },
  sinus: {
    ...
    defaultWW: 2000,
    colormap: 'bone',
    technique: 'Dedicated non-contrast paranasal sinus CT with ultra-thin 0.5mm coronal reformations.',
    findings: 'Bilateral maxillary, anterior/posterior ethmoid, frontal, and sphenoid sinuses are clear and fully aerated. Osteomeatal complexes (OMC) and sphenoethmoidal recesses are widely patent. Nasal septum is midline. Turbinates are symmetric.',
    impression: '1. Fully aerated paranasal sinuses without mucosal thickening or fluid levels. 2. Patent bilateral drainage pathways.'
  },
  historical_1971: {
    ...
    defaultWW: 400,
    colormap: 'gray',
    technique: 'First clinical CT scan in human history (1971) performed at Atkinson Morley Hospital using the EMI Mark I pencil-beam prototype (80×80 matrix, 300s per slice).',
    findings: 'Low spatial resolution (80×80 pixels) and prominent ring/streak artifacts characteristic of first-generation translation-rotation scanning. Crudely visualized cerebral hemispheres and calvarial vault.',
    impression: '1. Landmark historical first-generation EMI CT scan representing the genesis of medical computed tomography (Nobel Prize in Medicine 1979).'
  },
  polytrauma: {
    ...
    defaultWW: 800,
    colormap: 'hot',
    technique: 'Rapid whole-body "pan-scan" trauma protocol with dual-energy split-bolus IV contrast and kinematic 3D volume rendering.',
    findings: 'Complete skeletal survey demonstrates intact axial and appendicular skeleton. Major thoracic, abdominal, and pelvic vessels intact without active extravasation or pseudoaneurysm.',
    impression: '1. Negative whole-body polytrauma CT survey. 2. No surgical osseous injury or internal vascular disruption.'
  },
  pet: {
    ...
    defaultWW: 120,
    colormap: 'pet',
    technique: 'F-18 Fluorodeoxyglucose (FDG) molecular PET with photon-counting CT anatomical co-registration.',
    findings: 'Symmetric, physiological radiotracer uptake throughout cerebral cortical gray matter, basal ganglia, and cerebellar hemispheres. Preserved temporoparietal metabolic activity without hypometabolic deficits.',
    impression: '1. Normal cerebral glucose metabolism on molecular PET/CT. 2. No focal metabolic defect suggestive of neurodegenerative disease.'
  }
};
...
function buildColormap(name, size = 256) {
  ...
  for (let i = 0; i < size; i++) {
    ...
    if (name === 'gray') {
      ...
      if (t < 0.25) { r[i] = 0; g[i] = Math.round(t/0.25*255); b[i] = 255; }
      else if (t < 0.5) { const s=(t-0.25)/0.25; r[i]=0; g[i]=255; b[i]=Math.round((1-s)*255); }
      else if (t < 0.75) { const s=(t-0.5)/0.25; r[i]=Math.round(s*255); g[i]=255; b[i]=0; }
      else { const s=(t-0.75)/0.25; r[i]=255; g[i]=Math.round((1-s)*255); b[i]=0; }
    } else if (name === 'spectral') {
      const hue = (1 - t) * 270;
      const { r: hr, g: hg, b: hb } = hsvToRgb(hue, 1, 1);
      r[i] = hr; g[i] = hg; b[i] = hb;
    } else {
      const v = Math.round(t * 255); r[i] = g[i] = b[i] = v;
    }
  }
  return { r, g, b };
}
function hsvToRgb(h, s, v) {
  ...
  const arr = [[v,t,p],[q,v,p],[p,v,t],[p,q,v],[t,p,v],[v,p,q]][hi];
...
class CtImageEngine {
  constructor(canvas, hudState) {
    ...
    // Drag
    this._drag = false; this._dragStart = null;
    this._panStart = null;
  ...
  loadImage(url, era) {
    ...
    if (typeof MULTIPARAMETRIC_4D_B64 !== 'undefined' && (url.includes('multiparametric') || (era && era.id === 'future'))) {
      effectiveUrl = MULTIPARAMETRIC_4D_B64;
    }

    const img = new Image();
    // Only set crossOrigin for remote HTTP URLs when not on file:// protocol and not data URI
    if (location.protocol !== 'file:' && !effectiveUrl.startsWith('data:') && (effectiveUrl.startsWith('http://') || effectiveUrl.startsWith('https://') || effectiveUrl.startsWith('//'))) {
    ...
    img.onerror = () => {
      ...
      if (typeof MULTIPARAMETRIC_4D_B64 !== 'undefined' && effectiveUrl !== MULTIPARAMETRIC_4D_B64) {
  ...
  setWL(wl, ww) { this.wl = wl; this.ww = ww; this._dirty = true; }
  setActiveTool(tool) { this.activeTool = tool; }

  resetView() {
    this.panX = 0; this.panY = 0;
    this.zoom = 1.0; this.rotation = 0; this.flipH = false;
    this.rulerPoints = [];
    this._dirty = true;
  }
  rotateBy(deg) { this.rotation = (this.rotation + deg) % 360; this._dirty = true; }
  flip()        { this.flipH = !this.flipH; this._dirty = true; }
  ...
  _buildFrame(targetEra, targetKeV = 70, targetMat = 'std') {
    ...
    if (isFuture && State.currentScanType === 'multiparametric_4d' && targetMat === 'std' && this.colormapName === 'gray' && targetKeV === 70) {
      return src;
    }
    ...
    let processW = srcW, processH = srcH;
    ...
    if (targetMatrix < 512) {
      ...
      processCanvas.width = srcW; processCanvas.height = srcH;
    ...
    if (era.blur > 0) {
      ...
      tmp2.width = processW; tmp2.height = processH;
    ...
    const wl = this.wl, ww = this.ww;
    const wMin = wl - ww / 2, wMax = wl + ww / 2;
    const lut = this.lut;
  ...
  probeHU(x, y) {
    ...
    if (imgX < 0 || imgX >= this.srcCanvas.width || imgY < 0 || imgY >= this.srcCanvas.height) return null;
  ...
  addRulerPoint(x, y) {
    ...
    if (this.rulerPoints.length >= 2) {
      const a = this.rulerPoints[0], b = this.rulerPoints[1];
  ...
  _onMouseLeave() { this._drag = false; }
...
function updateHUD(eraId) {
  const era = ERA_DB[eraId];
  const meta = SCAN_METADATA[State.currentScanType] || SCAN_METADATA.brain;
  $('hudModality').textContent = `CT · ${meta.title.split(' ')[1] || 'Axial'} · ${era.kVp} kVp · ${era.mAs} mAs`;
  $('hudWWWL').textContent = `WL: ${State.wl}  WW: ${State.ww}`;
  $('hudMatrix').textContent = `${era.matrix}×${era.matrix} · Int16`;
  $('hudReconHud').textContent = `Recon: ${era.techShort.split(' · ').slice(-1)[0] || era.techShort}`;
  $('hudSliceNum').textContent = `Slice: ${State.sliceCurrent} / ${State.sliceTotal}`;
  $('hudZoom').textContent = `Zoom: ${State.hudZoom}×`;
  $('hudPatientId').textContent = `ID: CT-${era.year}-${State.currentScanType.toUpperCase().slice(0, 4)} · 054Y M`;
}
...
function updateScientificPanel(eraId) {
  ...
  grid.innerHTML = era.specs.map(s =>
    `<div class="spec-item">
...
function updateReportPanel() {
  ...
  $('repTechnique').textContent = `${meta.technique} (Reconstruction: ${era.techShort}, kVp: ${era.kVp}, Matrix: ${era.matrix}×${era.matrix}, Dose: ${era.dose} mSv).`;
  $('repFindings').textContent = `${meta.findings} ${era.noise > 0.2 ? 'Note: Image detail is limited by era acquisition noise and matrix resolution.' : 'Image quality optimal with high diagnostic SNR.'}`;
  $('repImpression').textContent = `${meta.impression} [Study acquired under ${era.year} ${era.name} parameters].`;
}
...
function openDicomModal() {
  ...
  tbody.innerHTML = era.dicomTags.map(([tag, name, vr, val]) =>
...
function wireToolbar() {
  ...
  $$('.preset-btn').forEach(btn => {
    btn.addEventListener('click', () => {
      const wl = parseInt(btn.dataset.wl), ww = parseInt(btn.dataset.ww);
      State.wl = wl; State.ww = ww;
  ...
  // Rotate/Flip/Reset
  $('btnRotCcw').onclick = () => { State.engine.rotateBy(-90); };
  $('btnRotCw').onclick  = () => { State.engine.rotateBy(90); };
  $('btnFlip').onclick   = () => { State.engine.flip(); };
  $('btnReset').onclick  = () => {
...
function wireCurtainMode() {
  ...
  btn.onclick = () => {
    ...
    $('curtainBadgeRight').textContent = `${ERA_DB[State.currentEraId].year} ${ERA_DB[State.currentEraId].name}`;
...
function renderAiCad() {
  ...
  if (type === 'multiparametric_4d') {
    items = [
      { x: 14, y: 15, w: 72, h: 14, label: 'T2 FLAIR: Normal Periventricular Signal (99.6%)', conf: '99.6%' },
      { x: 14, y: 31, w: 72, h: 14, label: 'DWI b:1000: Zero Cytotoxic Edema / Acute Ischemia', conf: '99.9%' },
      { x: 14, y: 47, w: 72, h: 14, label: 'ADC Map: Free Brownian Diffusion (99.7%)', conf: '99.7%' },
      { x: 14, y: 63, w: 72, h: 14, label: 'CBF Perfusion: Symmetrical Hemodynamics (65 ml/100g/min)', conf: '100%' },
      { x: 14, y: 79, w: 72, h: 14, label: 'SWI: Microvascular Integrity Preserved (Zero Microbleeds)', conf: '99.8%' },
    ];
  } else if (type === 'brain') {
    items = [
    ...
    items = [
      { x: 36, y: 35, w: 28, h: 30, label: 'Coronary LAD: 100% Patent (Stenosis 0%)', conf: '99.7%' },
      { x: 48, y: 22, w: 18, h: 16, label: 'Aortic Root: Normal Caliber', conf: '99.9%' },
    ];
  } else if (type === 'abdomen') {
    items = [
      { x: 24, y: 32, w: 28, h: 36, label: 'Hepatic Parenchyma: Homogeneous (99.5%)', conf: '99.5%' },
      { x: 54, y: 42, w: 20, h: 24, label: 'Renal Excretion: Normal Bilateral', conf: '99.2%' },
    ];
  } else {
    items = [
      { x: 35, y: 35, w: 30, h: 30, label: 'AI Segmentation: Anatomically Normal (99.2%)', conf: '99.2%' },
    ];
  }
...
function updateTelemetryBox(eraId) {
  ...
  $('telDoseVal').textContent = `${era.dose} mSv (${doseCut > 0 ? `-${doseCut}% خفض` : 'المعيار البدائي'})`;
  ...
  $('telSpeedVal').textContent = `${era.scanTime}s (${Math.round(300 / Math.max(0.01, era.scanTime))}× أسرع)`;
...
function wireSciPanel() {
  ...
  $$('.sci-tab').forEach(tab => {
    tab.onclick = () => {
      ...
      const targetPane = document.getElementById('pane' + tab.dataset.tab.split('_').map(capitalize).join(''));
...
function wireCineBar() {
  ...
  $$('.fps-btn').forEach(btn => {
    btn.onclick = () => {
      ...
      if (State.cinePlay) { stopCine(); startCine(); }
    };
  });
}
function startCine() {
...
function stopCine() {
  if (State.cineTimer) { clearInterval(State.cineTimer); State.cineTimer = null; }
}
...
function wireMouseHU() {
  ...
  canvas.addEventListener('click', e => {
    ...
    if (!rulerStart) {
      ...
      const mx = (rulerStart.x + x) / 2, my = (rulerStart.y + y) / 2;
      rulerSvg.innerHTML = `
...
function wireFileInput() {
  $('fileInput').onchange = e => {
    ...
    if (ext === 'dcm') {
      ...
      alert('ملف DICOM (.dcm) يحتاج إلى مكتبة Cornerstone.js لفك تشفيره.\nهذا التطبيق يدعم رفع ملفات الصور: PNG, JPEG, WebP.');
      return;
    }
...
document.addEventListener('keydown', e => {
  ...
  switch (e.key) {
    case '1': switchEra('era1');    break;
    case '2': switchEra('era2');    break;
    case '3': switchEra('era3');    break;
    case '4': switchEra('present'); break;
    case '5': switchEra('future');  break;
    case 'r': case 'R': State.engine.resetView(); break;
    case 'ArrowRight': case 'ArrowDown': {
      const s = $('sliceSlider');
      if (State.sliceCurrent < State.sliceTotal) { s.value = ++State.sliceCurrent; s.dispatchEvent(new Event('input')); }
      break;
    }
    case 'ArrowLeft': case 'ArrowUp': {
      const s = $('sliceSlider');
      if (State.sliceCurrent > 1) { s.value = --State.sliceCurrent; s.dispatchEvent(new Event('input')); }
      break;
    }
    case ' ':
      e.preventDefault();
