...
const routes = [
  {
    href: '/worklist',
    title: 'قائمة العمل',
    desc: 'الحالات في انتظار القراءة، مرتّبة حسب الأولوية والذكاء الاصطناعي',
    icon: ListChecks,
  },
  {
    href: '/reader/demo',
    title: 'القارئ',
    desc: 'عارض DICOM بـ Cornerstone3D + رؤى NEXUS Ensemble',
    icon: ScanEye,
  },
  {
    href: '/anatomy',
    title: 'مختبر التشريح',
    desc: '3D قلب/رئتين/دماغ/كليتين + BioDigital + محاكاة أمراض',
    icon: Heart,
  },
  {
    href: '/patient/demo',
    title: 'ملف المريض',
    desc: 'الجدول الزمني، المرفقات، الطلبات، الفواتير',
    icon: User,
  },
  {
    href: '/insights',
    title: 'الرؤى',
    desc: 'مقارنة نماذج NEXUS + uncertainty + قرارات إكلينيكية',
    icon: Sparkles,
  },
  {
    href: '/connect',
    title: 'الاتصال',
    desc: 'WhatsApp للأطباء المعالجين + QR للأطباء الخارجيين',
    icon: Send,
  },
  {
    href: '/console',
    title: 'وحدة التحكم',
    desc: 'المستخدمون، الأدوار، الإعدادات، لوحات القياس',
    icon: Settings,
  },
  {
    href: '/m',
    title: 'الجوّال',
    desc: 'PWA مختصرة للحالات الحرجة، push notifications',
    icon: Smartphone,
  },
];
